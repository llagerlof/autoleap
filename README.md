...
Use this option only if you intentionally want all users to depend on a clone managed by one trusted user account. For a safer and simpler multi-user setup, prefer Option 4.
